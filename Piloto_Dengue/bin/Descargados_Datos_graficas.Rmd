---
title: "Data downloaded of the Genome and E Gene of the Dengue virus"
output: html_notebook
---

These graphs describe the Dengue Virus records present in the database [bd_Dengue] (https://gitlab.com/AndreaSilva/LSB/tree/master/Piloto_Dengue/data/Base_Datos/Base_Datos_Dengue) that report the Genome and the Envelope Gene (Gen E). These cases meet the following conditions:

* They are not designated by GenBank as:
      + Chimeras
      + Clones
      + Not Verified
* Report the serotype
* Report the year of registration and Report the country

Genome:

* Length of the sequence> 10100 bp. Taking into account that the genome of the Degue virus is around 11,000 bp
* The GenBank specifies the beginning and end of the CDS

Gen E:

* Length of the sequences> 1300 bp <1600 bp. Taking into account that the length of the E gene reported by the GenBnak reference sequences is 1485 bp
