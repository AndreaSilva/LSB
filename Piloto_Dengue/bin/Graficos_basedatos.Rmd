...
plot_serotype <- ggplot(data = serotype[3:7,], aes(x= Name_serotype, y = count_data))+
  ...
  labs(x= "Serotipos", y= "Numero de datos")+
  ggtitle("Número de datos por Serotipos")+
  theme_minimal()+
...
pf <- ggplot()+ 
  ...
  scale_size(name="Número de casos")+
  ggtitle("Número de casos reportados por paises")+
  theme_tufte()+
  theme(plot.title = element_text(hjust=0.5))
...
pg <- ggplot()+ 
  ...
  ggtitle("Distribución de los serotipos por paises")+
  theme_tufte()+
  theme(plot.title = element_text(hjust=0.5))
