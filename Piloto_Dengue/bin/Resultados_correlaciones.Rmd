...
# distancia geogrfica
distGE_loan <- read.csv(file = "/home/andrea/LSB/Piloto_Dengue/data/Matrices_distancias/matrices_genE/matrices_geograficas/dist.GE.loan.csv")
...
```
Gen E Vs dist. geografica localidades
...
```
dist. geografica Vs dist temporal
...
```
Gen E DENV1 Vs dist. geografica
...
```
Gen E DENV2 Vs dist. geografica

```{r, echo=FALSE, warning=FALSE, message=FALSE}

mantel(xdis= FraccionalD2_loan, ydis= yearED2_loan)
```
Gen E DENV2 Vs dist. temporal
...
```
Gen E DENV3 Vs dist geografica

```{r, echo=FALSE, warning=FALSE, message=FALSE}

mantel(xdis= FraccionalD3_loan, ydis= yearED3_loan)
```
Gen E DENV3 Vs dist temporal
...
```
Gen E DENV4 Vs dist. geografica

```{r, echo=FALSE, warning=FALSE, message=FALSE}

mantel(xdis= FraccionalD4_loan, ydis= yearED4_loan)
```
Gen E DENV4 Vs dist. temporal
...
```
Gen E DENV2 Vs geografia paises
...
```
Gen E DENV 3 Vs Geografia paises
```{r, echo=FALSE, warning=FALSE, message=FALSE}
...
```
Gen e DENV 4 Vs geografica paises
...
```
Genoma Vs dist. geografica localidad

```{r, echo=FALSE, warning=FALSE, message=FALSE}

mantel(xdis= Fraccional_loan, ydis= yearG_loan)
```
Genoma Vs dist. temporal
...
```
Genoma DENV1 Vs dist. geografica
...
```
Genoma DENV2 Vs dist. geografica
...
```
Genoma DENV3 Vs dist. geografica
...
```
Genoma DENV4 Vs dist. geografica
...
```
Genoma Vs dist. geografica pais
...
```
Genoma DENV 1 Vs dist. temporal
...
```
Genoms DENV2 Vs dist. geografica
