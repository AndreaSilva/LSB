...
## GEN E VS GEOGRAFICA VS TIEMPO (PAIS Y AÑOS)
...
rownames(distED1_loan) <- distED1_loan$X
distED1_loan <- distED1_loan[2:39]

#dist temporal
yearED1_loan <- read.csv(file = "/home/andrea/LSB/Piloto_Dengue/data/Matrices_distancias/matrices_genE/matrices_temporalea/yearD1_paan.csv")
yearED1_loan$X <- colnames(yearED1_loan[2:39])
rownames(yearED1_loan) <- yearED1_loan$X
yearED1_loan <- yearED1_loan[2:39]
...
rownames(distED2_loan) <- distED2_loan$X
distED2_loan <- distED2_loan[2:49]

#dist temporal
yearED2_loan <- read.csv(file = "/home/andrea/LSB/Piloto_Dengue/data/Matrices_distancias/matrices_genE/matrices_temporalea/yearD2_paan.csv")
yearED2_loan$X <- colnames(yearED2_loan[2:49])
rownames(yearED2_loan) <- yearED2_loan$X
yearED2_loan <- yearED2_loan[2:49]
...
rownames(distED3_loan) <- distED3_loan$X
distED3_loan <- distED3_loan[2:24]

#dist temporal
yearED3_loan <- read.csv(file = "/home/andrea/LSB/Piloto_Dengue/data/Matrices_distancias/matrices_genE/matrices_temporalea/yearD3_paan.csv")
yearED3_loan$X <- colnames(yearED3_loan[2:24])
rownames(yearED3_loan) <- yearED3_loan$X
yearED3_loan <- yearED3_loan[2:24]
...
rownames(distED4_loan) <- distED4_loan$X
distED4_loan <- distED4_loan[2:22]

#dist temporal
yearED4_loan <- read.csv(file = "/home/andrea/LSB/Piloto_Dengue/data/Matrices_distancias/matrices_genE/matrices_temporalea/yearD4_paan.csv")
yearED4_loan$X <- colnames(yearED4_loan[2:22])
rownames(yearED4_loan) <- yearED4_loan$X
yearED4_loan <- yearED4_loan[2:22]
