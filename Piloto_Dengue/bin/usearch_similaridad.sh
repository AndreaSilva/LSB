#UCLUST
#USEARCH
# Code to search and remove sequences with 97% similarity in UCLUS-USEARCH
...
# Identify and remove the sequences
...
#Extract the ids from the sequences
...
# Original sequences Vs sequences with 97% dissimilarity
